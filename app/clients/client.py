...
# camera_data = requests.get("http://202.180.16.237:28080/master/api/camera")
# camera_data = camera_data.json()

# kamera_id = "CAM-008"
# selected_camera = None

# for camera in camera_data["data"]:
#     if camera["id"] == kamera_id:
#         selected_camera = camera
#         break

# if selected_camera is None:
#     raise ValueError("Kamera dengan ID yang diberikan tidak ditemukan")
